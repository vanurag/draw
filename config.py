...
# train_config['disc_model_dir'] = '/media/anurag/DATA-EXT/texture-synthesis/texture-datasets/ETH_Synthesizability/logs/DISC_1561538269'
...
#     "init": 25.0, "min": 15.0,
#     "decay_type": "fixed", "factor": -2.0, "iters": 1000,
#     "staircase": True
#   },
# }
...
train_config['annealing_schedules'] = {  # decay type: ['fixed', 'linear' or 'exponential']
  ...
  "stop_writing_threshold": {
    "init": 45.0, "min": 15.0,
    "decay_type": "linear", "factor":-5.0, "iters": 3000,
    "staircase": True
  },
}
